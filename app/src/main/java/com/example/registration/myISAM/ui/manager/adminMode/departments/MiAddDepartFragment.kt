...
import com.example.registration.ui.manager.adminMode.departments.AddDepartsViewModel
import dagger.hilt.android.AndroidEntryPoint
import kotlinx.coroutines.launch

@AndroidEntryPoint
class MiAddDepartFragment : Fragment() {

    private lateinit var binding: FragmentAddDepartBinding
    private val viewModel by viewModels<MiAddDepartsViewModel>()
