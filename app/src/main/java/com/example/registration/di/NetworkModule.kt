...
import com.example.registration.database.backendless.logging.LoggingApi
...
object NetworkModule {
    ...
    @Provides
    @Singleton
    fun provideLoggingApi(retrofit: Retrofit): LoggingApi = retrofit.create(LoggingApi::class.java)
}