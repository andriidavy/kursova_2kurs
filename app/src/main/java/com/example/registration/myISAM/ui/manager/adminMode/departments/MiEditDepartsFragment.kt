...
import com.example.registration.ui.manager.adminMode.departments.EditDepartsViewModel
import dagger.hilt.android.AndroidEntryPoint
import kotlinx.coroutines.launch

@AndroidEntryPoint
class MiEditDepartsFragment : Fragment() {

    private lateinit var binding: FragmentEditDepartsBinding
    private lateinit var adapter: AllDepartmentAdapter
    private lateinit var navController: NavController
    private val viewModel by viewModels<MiEditDepartsViewModel>()
    ...
    private fun setListeners() = with(binding) {
        buttonToAddDeparts.setOnClickListener {
            navController.navigate(R.id.action_miEditDepartsFragment_to_miAddDepartFragment)
        }
    }
