...
@AndroidEntryPoint
class MiEmployeeCustomsInProgressFragment : Fragment() {
    ...
    private val viewModel by viewModels<MiEmployeeCustomsInProgressViewModel>()
    ...
    private fun onCreateReportClick(): (Int) -> Unit {
        return { customId ->
            ...
            navController.navigate(
                R.id.action_miEmployeeCustomsInProgressFragment_to_miCreatingReportForCustomFragment,
                bundle
            )
        }
    }
    ...
    private fun onItemClick(): (Int) -> Unit {
        return { position ->
            ...
            navController.navigate(
                R.id.action_miEmployeeCustomsInProgressFragment_to_miCustomInProgressProductDetailFragment,
                bundle
            )
        }
    }
