...
import com.example.registration.ui.employee.customsProcessed.EmployeeCustomsProcessedViewModel
import dagger.hilt.android.AndroidEntryPoint
import kotlinx.coroutines.launch

@AndroidEntryPoint
class MiEmployeeCustomsProcessedFragment : Fragment() {
    ...
    private val viewModel by viewModels<MiEmployeeCustomsProcessedViewModel>()
    ...
    private fun onItemClick(): (Int) -> Unit {
        return { position ->
            ...
            navController.navigate(
                R.id.action_miEmployeeCustomsProcessedFragment_to_miCustomProcessedProductDetailFragment,
                bundle
            )
        }
    }
