...
import com.example.registration.ui.manager.reportsInWaiting.ManagerReportsInWaitingViewModel
import dagger.hilt.android.AndroidEntryPoint
import kotlinx.coroutines.launch

@AndroidEntryPoint
class MiManagerReportsInWaitingFragment : Fragment() {

    private lateinit var binding: FragmentManagerReportsInWaitingBinding
    private lateinit var adapter: ReportAdapter
    private lateinit var navController: NavController
    private val viewModel by viewModels<MiManagerReportsInWaitingViewModel>()
    ...
    private fun onItemClick(): (Int) -> Unit {
        return { position ->
            ...
            navController.navigate(
                R.id.action_miManagerReportsInWaitingFragment_to_miManagerReportsInWaitingDetailFragment,
                bundle
            )
        }
    }
