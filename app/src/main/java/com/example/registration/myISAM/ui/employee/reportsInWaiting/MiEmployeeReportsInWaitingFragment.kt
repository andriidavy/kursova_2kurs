...
@AndroidEntryPoint
class MiEmployeeReportsInWaitingFragment : Fragment() {

    private lateinit var binding: FragmentEmployeeReportsInWaitingBinding
    private lateinit var adapter: ReportAdapter
    private lateinit var navController: NavController
    private val viewModel by viewModels<MiEmployeeReportsInWaitingViewModel>()
    ...
    private fun onItemClick(): (Int) -> Unit {
        return { position ->
            ...
            navController.navigate(
                R.id.action_miEmployeeReportsInWaitingFragment_to_miReportDetailFragment,
                bundle
            )
        }
    }
