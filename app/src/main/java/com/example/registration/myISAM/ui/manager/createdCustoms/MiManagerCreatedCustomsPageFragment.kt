...
@AndroidEntryPoint
class MiManagerCreatedCustomsPageFragment : Fragment() {
    ...
    private val viewModel by viewModels<MiManagerCreatedCustomsPageViewModel>()
    ...
    private fun onAssignEmployeeClick(): (Int) -> Unit {
        return { customId ->
            ...
            navController.navigate(
                R.id.action_miManagerCreatedCustomsPageFragment_to_miEmployeesListForAssigneeToCustomFragment,
                bundle
            )
        }
    }
    ...
    private fun onItemClick(): (Int) -> Unit {
        return { position ->
            ...
            navController.navigate(
                R.id.action_miManagerCreatedCustomsPageFragment_to_miCreatedCustomsProductDetailFragment,
                bundle
            )
        }
    }
